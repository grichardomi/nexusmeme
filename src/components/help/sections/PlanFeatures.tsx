...
export function PlanFeatures({ searchQuery }: PlanFeaturesProps) {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer: `You are in full control — your bot keeps trading as long as your account is paid up.\n\n**Timeline if an invoice goes unpaid:**\n- Day 1: Invoice generated\n- Day 7: Reminder email\n- Day 10: Final warning with your suspension date\n- Day 14: Bot suspended — trading stops\n- Day 30: Invoice expires (written off as uncollectible)\n\n**Bot suspension means:**\n- No new trades are opened\n- Any open trades close normally\n- All your funds stay safe in your Binance account\n- Bot resumes automatically the moment payment confirms on-chain\n\n**What you owe if suspended:**\n- Performance fees from profitable trades before suspension (always owed — you earned the profits, we earned the fee)\n- Platform flat fee for months you actively traded (value was delivered)\n- Platform flat fee is NOT charged for suspended months (no value delivered)\n\n**How to pay:**\n1. Go to Dashboard → Billing & Plans\n2. Click "Pay Invoice" (or generate a new one if expired)\n3. Send exact USDC amount to the Base network wallet address shown\n4. Confirmation is automatic — bot resumes within seconds\n\nOnly USDC on Base network is accepted. No credit cards, no bank transfers.`,
    },
    {
