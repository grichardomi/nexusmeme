...
export function FAQSection({ searchQuery }: FAQSectionProps) {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer: `Trading pairs are the cryptocurrencies your bot trades:\n- BTC/USD: Bitcoin vs. US Dollar\n- ETH/USD: Ethereum vs. US Dollar\n\nYour bot is focused on BTC and ETH — the most established crypto markets. This disciplined approach means more consistent results than spreading across dozens of altcoins.`,
    },
    {
    ...
    {
      question: 'What happens if I lose my Binance API keys?',
      answer: `If you lose your Binance API keys (or think someone else might have them):\n\n1. Log in to binance.com immediately\n2. Go to Profile > API Management\n3. Delete the compromised API key\n4. Create a new API key:\n   - Click "Create API" → "System generated"\n   - Label it "NexusMeme Trading Bot"\n   - Enable: Reading + Spot & Margin Trading only\n   - Do NOT enable Withdrawals\n5. Copy the new API Key and Secret Key\n6. In NexusMeme, go to Account > Connected Exchanges\n7. Paste the new keys and click "Update"\n\nYour bot will continue working with the new keys. The old keys stop working immediately after you delete them on Binance.\n\nIMPORTANT: If you suspect unauthorized access, also change your Binance password and review your recent account activity on Binance.`,
    },
    {
      question: 'Is my account secure?',
      answer: `Security features:\n- All your data is encrypted (scrambled so hackers can't read it)\n- Your connection keys are stored securely\n- NexusMeme can only VIEW your balance and place trades\n- NexusMeme CANNOT withdraw money from your Binance account\n- We recommend enabling extra security on your Binance account\n\nBest practices to stay safe:\n- Use a strong, unique password on Binance\n- Enable 2-factor authentication on Binance (adds an extra login step)\n- Never share your API keys with anyone\n- Never enable "Withdrawals" on your Binance API key\n- Check your Binance account regularly for any suspicious activity`,
    },
    {
      question: 'Is NexusMeme available in my country?',
      answer: `NexusMeme is available globally — with one exception.\n\n**Available worldwide** including:\n- Southeast Asia (Philippines, Vietnam, Thailand, Indonesia, Singapore, Malaysia)\n- Europe (UK, Germany, France, Netherlands, and more)\n- Latin America (Brazil, Colombia, Argentina, Mexico)\n- Middle East (UAE, Turkey, Saudi Arabia)\n- Africa (Nigeria, Kenya, South Africa)\n- Most other countries where Binance International operates\n\n**Not available to US residents**\nNexusMeme uses Binance International (binance.com), which is not available to US persons (US citizens, residents, or entities) under Binance's Terms of Service. US residents should use Binance US (binance.us) separately — this is not supported by NexusMeme at this time.\n\n**Why Binance International?**\nBinance.com is the world's largest crypto exchange by volume, with deeper liquidity, tighter spreads, and lower effective trading costs — all of which directly improve your bot's profitability.\n\nIf you are unsure whether your country is supported, check whether you can create a Binance International account at binance.com.`,
    },
    {
      question: 'What exchange does NexusMeme support?',
      answer: `NexusMeme uses **Binance International (binance.com)** — the world's largest crypto exchange.\n\n**Important**: This is Binance International, NOT Binance US. US residents cannot use this service.\n\n**How it works:**\n- Your money stays in YOUR Binance account at all times\n- NexusMeme connects via API to view your balance and place trades\n- NexusMeme CANNOT withdraw your money (only you can)\n- You can revoke API access from Binance anytime\n\n**Why Binance International?**\n- Highest global liquidity = better trade execution\n- Low fees (0.1% per trade) = more profit stays in your pocket\n- Available in 180+ countries worldwide\n- Deep BTC & ETH markets = tighter spreads\n\n**To get started:**\n1. Create a Binance account at binance.com (not binance.us)\n2. Complete identity verification (required for trading)\n3. Create an API key with "Spot Trading" permissions only — do NOT enable withdrawals\n4. Connect your API key in NexusMeme: Dashboard > Settings > API Keys\n5. Start your free trial!\n\nMore exchanges may be added in the future.`,
    },
    {
