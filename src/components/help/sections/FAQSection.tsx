...
export function FAQSection({ searchQuery }: FAQSectionProps) {
  ...
  const questions = [
    ...
    {
      question: 'What currency does NexusMeme use for trading vs. fees?',
      answer: `NexusMeme uses two separate currencies for two separate purposes — never mixed:\n\n**USDT (Tether) — for trading**\n- All crypto trades settle in USDT\n- BTC/USDT: you buy Bitcoin, proceeds return as USDT\n- ETH/USDT: you buy Ethereum, proceeds return as USDT\n- USDT stays in your Binance account at all times\n- USDT is the quote currency: 1 USDT ≈ $1.00 USD\n\n**USDC (USD Coin) — for performance fee payments only**\n- Performance fee invoices are denominated in USDC\n- Paid on Base network (low gas, fast confirmation)\n- Accepted via MetaMask, WalletConnect, or manual transfer\n- USDC is never used for trading — it stays separate\n\n**Why separate?**\nYour trading capital (USDT) never touches the fee payment system (USDC). Your bot trades exclusively with USDT so your balance stays predictable and there's zero risk of trading capital being confused with fee payments.\n\n**Don't have USDT? Convert directly on Binance:**\n1. Log in to Binance and go to **Wallet → Spot**\n2. Find the currency you want to convert (e.g. USDC, BTC, ETH, USD)\n3. Click **Convert** next to that asset\n4. Select **USDT** as the target currency and enter your amount\n5. Confirm — conversion is instant with no trading fees\n\nAlternatively: go to **Trade → Convert**, select your source asset → USDT, and hit Convert. Your USDT balance will be ready for the bot immediately.`,
    },
    {
      question: 'What are my billing obligations and what happens if I don\'t pay?',
      answer: `Understanding your billing obligations is important. Here is the complete picture:\n\n**Two-part fee structure:**\n1. **Platform flat fee** — charged monthly for infrastructure (billed on the 1st, covers the previous month you used the platform)\n2. **Performance fee (${fee})** — charged only on profitable trades, calculated at month end\n\n**Your billing timeline:**\n- **Day 1**: Invoice generated for previous month's fees\n- **Day 7**: Reminder email sent if unpaid\n- **Day 10**: Final warning email with your suspension date\n- **Day 14**: Bot suspended — trading stops automatically\n- **Day 30**: Unpaid invoice expires and is written off as uncollectible\n\n**You control whether your bot keeps trading:**\nPayment is entirely in your hands. Your bot runs as long as your account is in good standing. If suspended, it resumes automatically the moment your payment is confirmed on-chain — no manual intervention needed from our side.\n\n**What you owe if suspended:**\n- Performance fees from profitable trades already made (these are always owed)\n- Platform flat fee for any month you actively traded (value was delivered)\n- Platform flat fee is NOT charged for months your bot was suspended (zero value delivered)\n- Outstanding fees from before suspension must be settled to reinstate trading\n\n**How to pay:**\n1. Go to Dashboard → Billing & Plans\n2. Click "Pay Invoice"\n3. Send the exact USDC amount shown to the wallet address on Base network\n4. Payment confirms automatically within seconds\n5. Bot resumes trading immediately after confirmation\n\n**Important:** If your invoice has expired (after 30 days), generate a new one in Billing & Plans. Unpaid fees don't disappear — they remain on your account and must be settled before trading resumes.`,
    },
    {
