...
export function GettingStarted({ searchQuery }: GettingStartedProps) {
  const questions = [
    ...
    },
    {
      ...
      answer: `1. Sign up for a free account - you'll get a 10-day live trading trial with $200 capital
...
6. Start live trading during your trial period`,
    },
    {
      ...
      answer:
        'No! All new users get a 10-day live trading trial with $200 capital. No credit card required. After the trial ends, you only pay 5% on profits if you want to continue trading.',
    },
    {
...
Note: Never share your secret key with anyone except NexusMeme.`,
    ...
    },
    {
      ...
      answer:
        'Every new user gets a 10-day live trading trial with $200 capital to test NexusMeme with real market conditions. No payment required during the trial. After the trial ends, you can continue trading by adding a payment method and paying 5% on profits.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'During your 10-day trial, you get $200 to test with. After the trial, there is no minimum capital requirement - you can trade with any amount. The more capital you have, the more you can trade.',
    },
    {
    ...
    <div className="space-y-4">
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
        ...
        <p className="text-slate-700 dark:text-slate-300">
          Start your automated trading journey in minutes. All new users get a 10-day live trading trial with $200 capital.
        </p>
      </div>
