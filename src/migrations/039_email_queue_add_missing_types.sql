-- Migration 039: Add missing email types to email_queue constraint
-- Adds: upcoming_billing, bot_resumed, trial_started, invoice_expired,
--       fee_rate_changed, login_alert, low_balance
