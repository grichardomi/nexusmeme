          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-slate-600 dark:text-slate-400">Automated trading while you sleep</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">BTC · ETH</div>
                <p className="text-slate-600 dark:text-slate-400">Trades the pairs that matter most</p>
              </div>
            </div>
          </div>
        </section>
