      ...
      {bots.length > 0 && hasApiKeys === false && (
        <div className="mb-6 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <Link
            ...
            className="flex-shrink-0 px-4 py-3 min-h-[44px] flex items-center justify-center bg-amber-600 hover:bg-amber-700 text-white text-sm font-medium rounded transition"
          >
            Connect API Keys
          </Link>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
          {bots.length === 0 && (
            <Link
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 min-h-[44px] flex items-center justify-center rounded font-medium transition text-sm"
            >
              + Create Bot
            </Link>
          )}
          <Link
            ...
            className="bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-900 dark:text-white px-4 py-3 min-h-[44px] flex items-center justify-center rounded font-medium transition text-sm"
          >
            📊 Live Trading
          </Link>
          <Link
          ...
          <div className="px-4 pb-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
              <button
                ...
                className="px-3 py-2.5 min-h-[44px] flex items-center justify-center text-sm font-medium text-green-700 dark:text-green-300 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/40 transition"
              >
                📥 Export CSV
              </button>
              ...
              <div className="flex gap-1.5 overflow-x-auto scrollbar-hide pb-1">
                {filterButtons.map((filter) => (
                  <button
                    ...
                    className={`px-3 py-2.5 min-h-[44px] flex items-center justify-center rounded text-xs font-medium whitespace-nowrap transition ${
